...
namespace HotelSystem.Infrastructure.WPF.Styles.MainWindow
{
    public static class WindowDragBehavior
    {
        ...
        public static readonly DependencyProperty LeftMouseButtonDrag =
           DependencyProperty.RegisterAttached("LeftMouseButtonDrag", typeof(Window),
              typeof(WindowDragBehavior), new UIPropertyMetadata(null, OnLeftMouseButtonDragChanged));
